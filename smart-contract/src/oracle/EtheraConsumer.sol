...
import {EtheraOracle} from "./EtheraOracle.sol";

contract EtheraConsumer is ReceiverTemplate {
    EtheraOracle public oracleContract;
    ...
    constructor(
        ...
        oracleContract = EtheraOracle(_oracle);
    }
