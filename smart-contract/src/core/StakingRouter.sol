...
contract StakingRouter is BeaconChainDepositor {
    ...
    address public immutable ETHERA;
    ...
    modifier onlyProtocol() {
        require(msg.sender == ETHERA, "Only ETHERA Protocol can trigger");
        _;
    }
    ...
    function triggerDeposit() external onlyProtocol {
